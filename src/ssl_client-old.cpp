...
void iotvp::ssl_init(iotvp::sslclient_context *ssl_client)
{
...
int iotvp::start_ssl_client(iotvp::sslclient_context *ssl_client, uint32_t ipAddress, uint32_t port, const char *rootCABuff, const char *cli_cert, const char *cli_key)
{
    char buf[512];
    ...
    */
    ...
    if ((flags = mbedtls_ssl_get_verify_result(&ssl_client->ssl_ctx)) != 0) {
        ...
        iotvp::stop_ssl_socket(ssl_client, rootCABuff, cli_cert, cli_key);  //It's not safe continue.
        return handle_error(ret);
    } else {
...
void iotvp::stop_ssl_socket(iotvp::sslclient_context *ssl_client, const char *rootCABuff, const char *cli_cert, const char *cli_key)
{
...
int iotvp::data_to_read(iotvp::sslclient_context *ssl_client)
{
    int ret, res;
...
int iotvp::send_ssl_data(iotvp::sslclient_context *ssl_client, const uint8_t *data, uint16_t len)
{
...
int iotvp::get_ssl_receive(iotvp::sslclient_context *ssl_client, uint8_t *data, int length)
{
